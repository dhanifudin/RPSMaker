...
## Metode Pengerjaan
Membaca dan merangkum materi, merefleksikan konsep terhadap konteks diri sendiri, menjawab pertanyaan analisis, mendokumentasikan evidence belajar, dan mengumpulkan hasil sesuai jadwal.

## Bentuk Format Luaran
Laporan/jurnal refleksi, ringkasan analisis, portofolio digital bertahap, dan/atau dokumen self-assessment.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Ketepatan dan kedalaman analisis topik karir | 11 | Analisis topik menunjukkan pemahaman mendalam, relevansi dengan konteks profesional informatika, dan dikaitkan dengan potensi serta rencana karir diri sendiri secara spesifik. | Analisis cukup baik dan mencakup topik utama tetapi relevansi dengan konteks diri atau kedalaman argumen masih terbatas. | Analisis tidak menunjukkan pemahaman topik karir yang memadai atau tidak relevan dengan konteks profesional. |
