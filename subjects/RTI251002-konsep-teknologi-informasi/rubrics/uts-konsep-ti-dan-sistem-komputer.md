...
# UTS Konsep TI dan Sistem Komputer
...
## Metode Pengerjaan
Mengerjakan soal UTS secara mandiri melalui platform ujian online dalam waktu 60 menit.

## Bentuk Format Luaran
Jawaban UTS online yang terekam pada platform ujian.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Penguasaan konsep TI, inovasi, IPTEK, etika, dan ICT | 7 | Menjawab benar penerapan konsep TI, inovasi, IPTEK, etika, dan perbedaan ICT/TIK pada kasus yang diberikan. | Konsep dasar dijawab benar, tetapi penerapannya pada kasus belum lengkap. | Jawaban tidak menunjukkan pemahaman konsep TI dan ICT. |
