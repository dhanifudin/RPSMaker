...
## Metode Pengerjaan
Mengerjakan soal kuis secara mandiri melalui platform ujian online dalam waktu 60 menit.

## Bentuk Format Luaran
Jawaban kuis online yang terekam pada platform ujian.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Ketepatan konversi sistem bilangan dan representasi data | 5 | Mengonversi bilangan antar basis dan menentukan representasi/tipe data dengan langkah dan hasil benar. | Langkah konversi benar, tetapi terdapat kesalahan hitung pada sebagian soal. | Tidak memahami langkah konversi bilangan atau representasi data. |
