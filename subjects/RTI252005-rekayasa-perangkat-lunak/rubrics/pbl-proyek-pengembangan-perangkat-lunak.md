...
# PBL Proyek Pengembangan Perangkat Lunak
...
## Metode Pengerjaan
Membentuk tim Scrum dan menyusun Product Backlog, melakukan Sprint Planning, merancang arsitektur dan menerapkan Design Pattern, mengelola papan Kanban dengan WIP limits dan daily stand-up, serta melakukan coding kolaboratif dengan Git dan code review.

## Bentuk Format Luaran
Dokumen Product Backlog, project blueprint, project board (Trello/Jira/GitHub Projects), source code pada repository Git, dan demo aplikasi.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Kelengkapan artefak Scrum dan Product Backlog | 10 | User Stories memenuhi kriteria INVEST, prioritas backlog jelas, peran tim sesuai, dan definisi Done (DoD) tegas. | Artefak Scrum tersedia, tetapi kualitas User Stories, prioritas, atau DoD belum konsisten. | Artefak Scrum tidak lengkap atau prosedur events Scrum tidak dijalankan. |
