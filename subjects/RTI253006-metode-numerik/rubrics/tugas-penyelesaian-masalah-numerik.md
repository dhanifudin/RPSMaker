...
sub_cpmk: SCPMK707-03501, SCPMK902-03502, SCPMK902-03503, SCPMK1007-03504
assessment_form: Tugas terstruktur individu
---

# Tugas Penyelesaian Masalah Numerik

**Bentuk Tugas/Evaluasi:** Tugas terstruktur individu

**Sub-CPMK:** SCPMK707-03501, SCPMK902-03502, SCPMK902-03503, SCPMK1007-03504
...
## Metode Pengerjaan
Mempelajari konsep dan algoritma metode numerik, menyelesaikan soal perhitungan step-by-step secara manual dan/atau menggunakan perangkat lunak, mendokumentasikan proses dan hasil, kemudian mengumpulkan sesuai batas waktu.

## Bentuk Format Luaran
Lembar jawaban dengan proses perhitungan lengkap (kerja tangan dan/atau file perangkat lunak), tabel iterasi bila diperlukan, dan analisis galat.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Ketepatan proses dan hasil perhitungan numerik | 8 | Proses perhitungan dilakukan dengan algoritma yang benar, tabel iterasi (bila ada) lengkap dan akurat, serta hasil akhir tepat sesuai kunci jawaban. | Proses perhitungan sebagian besar benar, tetapi ada kesalahan pada satu atau dua langkah iterasi atau hasil akhir kurang presisi. | Proses perhitungan salah secara fundamental, tabel iterasi tidak lengkap, atau hasil akhir sangat menyimpang dari nilai yang benar. |
