...
assessment_form: UTS berbasis demo dan presentasi
---

# UTS Milestone Review

**Bentuk Tugas/Evaluasi:** UTS berbasis demo dan presentasi

**Sub-CPMK:** SCPMK803-03603

## Deskripsi
Mahasiswa mendemonstrasikan kemajuan proyek SI dan mempertahankan keputusan teknis dan manajerial yang telah diambil.

## Metode Pengerjaan
Mempersiapkan demo produk, laporan kemajuan, dan presentasi yang mencakup pencapaian sprint, risiko aktual, dan rencana ke depan.

## Bentuk Format Luaran
Demo sistem yang berjalan, laporan kemajuan proyek, dan bahan presentasi.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Kelengkapan demo fitur Sprint 1-2 | 7 | Demo menunjukkan semua fitur Sprint 1-2 yang berfungsi, alur pengguna jelas, dan dapat dioperasikan oleh penguji. | Demo menunjukkan sebagian besar fitur, tetapi beberapa alur atau fungsionalitas masih belum stabil. | Demo tidak dapat dilaksanakan atau banyak fitur yang tidak berfungsi. |
