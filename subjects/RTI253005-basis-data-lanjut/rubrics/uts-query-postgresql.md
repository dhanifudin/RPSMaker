...
# UTS Query dan Objek Basis Data PostgreSQL

**Bentuk Tugas/Evaluasi:** UTS (ujian praktik PostgreSQL, closed book)

**Sub-CPMK:** SCPMK0203-02301, SCPMK0203-02302, SCPMK0701-02303
...
## Metode Pengerjaan
Mengerjakan soal berbasis studi kasus PostgreSQL secara individu dengan sifat closed book sesuai jadwal asesmen.

## Bentuk Format Luaran
File skrip SQL dan/atau lembar jawaban UTS.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Ketepatan query dasar dan lanjutan | 6 | Query DDL, DML, sub-query, JOIN, dan CTE benar dan menghasilkan data sesuai studi kasus UTS. | Sebagian besar query benar, tetapi ada kesalahan logika atau output yang kurang tepat. | Banyak query salah atau tidak dapat dieksekusi. |
