...
sub_cpmk: SCPMK0802-04802, SCPMK0205-04806, SCPMK0607-04805
assessment_form: Project Based Learning
---

# Sprint Implementasi Multi-Platform (Sprint 1-4)

**Bentuk Tugas/Evaluasi:** Project Based Learning

**Sub-CPMK:** SCPMK0802-04802, SCPMK0205-04806, SCPMK0607-04805

## Deskripsi
Mahasiswa mengimplementasikan aplikasi multi-platform secara bertahap melalui empat sprint agile dengan dokumentasi lengkap, integrasi komponen, blueprint arsitektural yang modular dan scalable, serta kolaborasi tim yang terukur.

## Metode Pengerjaan
Melaksanakan sprint planning, merancang blueprint arsitektural, mengimplementasikan fitur sesuai backlog, melakukan code review dan integrasi, mendokumentasikan sprint log, dan mempresentasikan progres.

## Bentuk Format Luaran
Kode sumber terintegrasi di repositori, sprint log, burndown chart, dokumentasi API, blueprint arsitektural, dan demo produk per sprint.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Kualitas implementasi fitur dan kepatuhan sprint | 13 | Fitur terdeliver sesuai sprint goal, kode berjalan tanpa error kritis, acceptance criteria terpenuhi, dan backlog terkelola. | Sebagian besar fitur terdeliver tetapi beberapa acceptance criteria atau kualitas kode belum optimal. | Fitur tidak terdeliver sesuai sprint goal atau kode mengandung error kritis yang tidak diselesaikan. |
...
| Kualitas blueprint arsitektural | 3 | Blueprint arsitektural dan komponen solusi dirancang modular, maintainable, dan scalable sesuai kebutuhan proyek. | Blueprint tersedia, tetapi modularitas atau scalability belum sepenuhnya dipertimbangkan. | Blueprint arsitektural tidak tersedia atau tidak mendukung pengembangan lanjutan. |
