...
# UTS Logika, Himpunan, Relasi, Fungsi, dan Sistem Bilangan
...
## Metode Pengerjaan
Mengerjakan soal UTS secara individual dalam waktu terbatas dengan menuliskan langkah penyelesaian yang runtut untuk setiap soal.

## Bentuk Format Luaran
Lembar jawaban UTS dengan langkah penyelesaian dan jawaban akhir.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Ketepatan penyelesaian soal logika proposisi | 8 | Tabel kebenaran, penyederhanaan proposisi, dan pembuktian ekivalensi dikerjakan benar dan lengkap. | Prosedur benar, tetapi terdapat kesalahan hitung atau langkah penyederhanaan yang terlewat. | Prosedur keliru atau kesimpulan tidak sesuai hasil tabel kebenaran. |
