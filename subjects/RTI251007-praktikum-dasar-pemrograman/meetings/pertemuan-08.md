...
Modalitas: Luring. Metode: ujian praktik individu.

## Estimasi Waktu
1 x 6 x 50' praktikum.

## Pengalaman Belajar Mahasiswa
Mahasiswa menyelesaikan soal ujian praktik pembuatan program pemilihan dan perulangan secara mandiri.

## Penilaian
Bentuk penilaian: UTS (ujian praktik). Mengacu rubrik RTM.

## Indikator Penilaian
Ketepatan analisis kasus; ketepatan implementasi pemilihan dan perulangan; kode berjalan sesuai output.
