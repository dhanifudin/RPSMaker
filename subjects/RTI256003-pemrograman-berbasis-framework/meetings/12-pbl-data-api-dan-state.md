...
Mahasiswa mengerjakan aktivitas terarah untuk pbl data/api dan state dan menunjukkan evidence hasil belajar.

## Penilaian
Bentuk penilaian: PBL data/API dan state. Mengacu rubrik RTM.
