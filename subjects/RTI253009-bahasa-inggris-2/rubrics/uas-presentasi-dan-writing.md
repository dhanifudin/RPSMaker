...
# UAS Final Presentation dan Writing Test
...
## Metode Pengerjaan
Mengerjakan tes menulis tentang topik teknis yang diberikan dan menyampaikan presentasi final dalam bahasa Inggris.

## Bentuk Format Luaran
Tulisan akhir teknis dan rekaman presentasi final.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Kualitas tulisan akhir | 10 | Teks teknis ditulis dengan struktur yang baik, kosakata teknis tepat, argumen koheren, dan tata bahasa yang benar. | Tulisan cukup baik tetapi ada kekurangan pada struktur argumen atau ketepatan tata bahasa. | Tulisan tidak terstruktur atau banyak kesalahan yang mengganggu pemahaman. |
