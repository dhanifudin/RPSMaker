...
# Tugas 2: Identifikasi Tipe dan Level Pengujian
...
## Deskripsi
Mahasiswa mengidentifikasi pendekatan, tipe, dan level pengujian pada studi kasus.

## Metode Pengerjaan
Mengklasifikasikan kebutuhan uji, menentukan tipe/level uji, dan memberi alasan pemilihan.

## Bentuk Format Luaran
Laporan klasifikasi pengujian PDF.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Klasifikasi pendekatan pengujian | 0.8 | Manual, automated, black-box, white-box, dan gray-box diklasifikasikan sesuai kebutuhan kasus. | Klasifikasi cukup tepat, tetapi beberapa pendekatan belum dibedakan jelas. | Klasifikasi keliru atau tidak sesuai kasus. |
