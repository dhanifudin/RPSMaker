...
assessment_form: Kuis berbasis checkpoint PBL kelompok
---

# Kuis 1: Konsep SQA dan Perencanaan Awal

**Bentuk Tugas/Evaluasi:** Kuis berbasis checkpoint PBL kelompok

**Sub-CPMK:** SCPMK608-04201, SCPMK608-04202

## Deskripsi
Mahasiswa mengevaluasi kesiapan awal proyek kelompok melalui konteks QA, pemetaan standar mutu, ruang lingkup pengujian, risiko awal, dan traceability awal.

## Metode Pengerjaan
Kelompok menyusun artefak checkpoint, mempresentasikan rationale QA, dan menjawab validasi dosen terhadap keputusan awal proyek.

## Bentuk Format Luaran
Dokumen checkpoint QA awal dan catatan validasi/presentasi kelompok.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Konteks QA proyek | 4 | Konteks aplikasi, masalah mutu, stakeholder, dan quality attribute awal dijelaskan jelas. | Konteks QA cukup jelas, tetapi stakeholder atau quality attribute belum lengkap. | Konteks QA tidak jelas atau tidak terkait proyek. |
