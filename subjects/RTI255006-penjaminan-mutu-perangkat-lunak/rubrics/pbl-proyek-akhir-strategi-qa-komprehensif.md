...
sub_cpmk: SCPMK0608-04201, SCPMK0608-04202, SCPMK0608-04203, SCPMK0608-04204
assessment_form: Project Based Learning
---

# PBL/Proyek Akhir: Strategi QA Komprehensif

**Bentuk Tugas/Evaluasi:** Project Based Learning

**Sub-CPMK:** SCPMK0608-04201, SCPMK0608-04202, SCPMK0608-04203, SCPMK0608-04204

## Deskripsi
Mahasiswa mengintegrasikan strategi QA lengkap pada aplikasi studi kasus.

## Metode Pengerjaan
Menganalisis kebutuhan mutu, menyusun strategi QA, menjalankan functional dan non-functional testing, serta menyusun laporan akhir.

## Bentuk Format Luaran
Laporan proyek, artefak pengujian, evidence, repository/script, dan presentasi.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Integrasi strategi QA proyek | 10 | Quality model, risk, test strategy, planning, functional, dan non-functional testing terintegrasi pada proyek. | Strategi cukup terintegrasi, tetapi sebagian risiko atau jenis uji belum lengkap. | Strategi QA terfragmentasi atau tidak sesuai proyek. |
