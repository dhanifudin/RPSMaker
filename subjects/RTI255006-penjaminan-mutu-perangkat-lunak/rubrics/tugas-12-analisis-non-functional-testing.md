...
# Tugas 12: Analisis Non-Functional Testing
...
## Metode Pengerjaan
Mengidentifikasi quality attributes, prioritas risiko, dan strategi non-functional testing.

## Bentuk Format Luaran
Laporan analisis non-functional testing.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Identifikasi quality attributes | 1.2 | Performance, security, usability, reliability, maintainability, atau atribut relevan dipilih sesuai konteks. | Atribut kualitas cukup relevan, tetapi beberapa prioritas belum didukung konteks. | Atribut kualitas tidak relevan atau tidak teridentifikasi. |
