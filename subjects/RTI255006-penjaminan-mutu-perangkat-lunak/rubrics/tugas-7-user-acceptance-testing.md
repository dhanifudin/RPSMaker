...
# Tugas 7: User Acceptance Testing
...
## Metode Pengerjaan
Menyusun UAT plan, menjalankan simulasi user, dan mencatat hasil eksekusi.

## Bentuk Format Luaran
Dokumen UAT plan dan execution record.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Kesesuaian UAT dengan user story | 1.2 | UAT plan, user story, acceptance criteria, dan peran user konsisten. | UAT cukup sesuai, tetapi acceptance criteria atau role user belum lengkap. | UAT tidak berangkat dari kebutuhan pengguna. |
