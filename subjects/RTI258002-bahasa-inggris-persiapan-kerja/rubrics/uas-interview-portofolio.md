...
## Metode Pengerjaan
Menyiapkan portofolio final, menjalani mock interview panel (30 menit), mempresentasikan portofolio karier, dan merespons pertanyaan panel.

## Bentuk Format Luaran
Portofolio profesional final (digital), rekaman/live mock interview panel, dan slide presentasi portofolio.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
| --- | ---: | --- | --- | --- |
| Performa mock interview panel | 10 | Mahasiswa menjawab semua pertanyaan panel (HR, manajer teknis, dan penguji) dengan lancar, tepat, dan profesional menggunakan Bahasa Inggris baku. | Sebagian besar pertanyaan dijawab dengan baik, tetapi ada beberapa pertanyaan teknis atau behavioral yang kurang memuaskan. | Tidak dapat menjawab banyak pertanyaan panel, bahasa tidak profesional, atau tidak siap menghadapi format panel interview. |
