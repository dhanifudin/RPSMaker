...
# Sprint Rekayasa Sistem

## Deskripsi
Mahasiswa mengeksekusi sprint rekayasa sistem meliputi validasi arsitektur, implementasi pipeline CI/CD, strategi deployment, dan UTS milestone berupa presentasi arsitektur dan SRS kepada stakeholder.

## Metode Pengerjaan
Melaksanakan sprint planning, memvalidasi arsitektur dengan stakeholder, mengimplementasikan CI/CD, merancang strategi deployment, dan mendokumentasikan setiap sprint.

## Bentuk Format Luaran
Artefak arsitektur tervalidasi, pipeline CI/CD berjalan, laporan sprint, bukti demo, dan evidence UTS milestone.
