...
## Deskripsi
Mahasiswa menyusun dokumen arsitektur sistem enterprise yang komprehensif, mencakup diagram komponen, antarmuka, aliran data, keputusan arsitektur (ADR), dan spesifikasi kebutuhan awal.

## Metode Pengerjaan
Menganalisis konteks sistem, merancang komponen dan antarmuka, mendokumentasikan keputusan arsitektur, dan menyusun kebutuhan awal dalam format SRS.

## Bentuk Format Luaran
Dokumen arsitektur (C4 diagram/UML), ADR, spesifikasi kebutuhan awal, dan presentasi arsitektur.

## Rubrik Penilaian

| Indikator Penilaian | Bobot (%) | Kriteria 3 (Baik) | Kriteria 2 (Cukup) | Kriteria 1 (Kurang) |
|---|---|---|---|---|
| Kelengkapan dan kualitas desain arsitektur | 6 | Komponen, antarmuka, aliran data, dan ketergantungan antar modul dirancang dengan benar dan terdokumentasi dalam diagram yang dapat dibaca. | Desain arsitektur mencakup komponen utama, tetapi beberapa antarmuka atau aliran data belum terdokumentasi lengkap. | Desain arsitektur tidak lengkap, diagram tidak dapat dibaca, atau tidak mencerminkan kebutuhan sistem. |
