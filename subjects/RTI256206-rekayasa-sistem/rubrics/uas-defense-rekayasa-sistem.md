...
# UAS Defense Rekayasa Sistem

## Deskripsi
Mahasiswa melakukan defense arsitektur sistem enterprise yang dirancang dan mendemonstrasikan pipeline deployment yang diimplementasikan kepada panel penguji akademik dan industri.

## Metode Pengerjaan
Mempersiapkan materi defense, mendemonstrasikan arsitektur sistem dan pipeline deployment, serta menjawab pertanyaan teknis mengenai keputusan desain dan implementasi.

## Bentuk Format Luaran
Materi presentasi, demonstrasi arsitektur dan deployment pipeline yang berjalan, dan dokumentasi sistem akhir.
