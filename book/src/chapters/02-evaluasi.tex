...
\subsection{Persiapan Konsultasi Advisory Board (Kaji Ulang PPM, CPL, dan Kurikulum)}

Sebagai bagian dari siklus kaji ulang (evaluasi berkelanjutan) Kurikulum 2025 Program Studi D4 Teknik Informatika, pada hari Senin, 30 Juni 2025 (pukul 11.00--13.00, Ruang Meeting 2) dilaksanakan rapat internal dengan agenda ``Rapat Internal Prodi untuk Kaji Ulang PPM, CPL, dan Kurikulum'', diikuti oleh 12 peserta internal. Notulen rapat disahkan oleh Koordinator Program Studi, Dr. Ely Setyo Astuti, S.T., M.T.

\textit{Rapat ini merupakan persiapan internal untuk menyusun topik dan pertanyaan yang akan dikonsultasikan kepada Advisory Board pada pertemuan berikutnya --- bukan merupakan catatan masukan yang telah diterima dari industri sebagaimana FGD pada Subbagian sebelumnya.} Poin-poin yang dibahas dan direncanakan untuk dikonsultasikan:

\begin{enumerate}
\item \textbf{Evaluasi Value dan Positioning Program Studi} --- memperjelas karakteristik pembeda lulusan, kompetensi utama yang perlu ditonjolkan, kesesuaian positioning dengan kebutuhan industri, serta kemungkinan integrasi potensi daerah.
\item \textbf{Evaluasi Struktur Kurikulum} --- kesesuaian mata kuliah dasar pada semester awal, waktu penguatan kompetensi teknologi, keseimbangan kompetensi dasar/teknis/pendukung, serta pengembangan mata kuliah pilihan dan bidang peminatan (mengacu pada struktur Kurikulum 2025 yang telah disusun pada Bab VI).
\item \textbf{Kesesuaian Kurikulum dengan Kebutuhan Industri} --- pertanyaan yang direncanakan mencakup kompetensi yang paling dibutuhkan industri, kesesuaian kompetensi lulusan saat ini, teknologi yang perlu diperkenalkan, bentuk keterlibatan industri dalam pembelajaran, serta tren kebutuhan tenaga kerja bidang informatika.
\item \textbf{Penguatan Karakter Program Sarjana Terapan} --- lulusan diharapkan tidak hanya mampu melakukan pekerjaan teknis/coding, tetapi juga analisis permasalahan, pemahaman kebutuhan pengguna, proses bisnis, critical thinking, problem solving, perancangan solusi, dan implementasi pada konteks nyata.
\item \textbf{Penguatan Critical Thinking dan Problem Solving (CTPS)} --- posisi mata kuliah CTPS dalam struktur kurikulum, bentuk pembelajaran, keterkaitan dengan proyek dan kasus nyata industri, serta kesinambungannya hingga semester akhir.
\item \textbf{Penguatan Pemahaman Proses Bisnis} --- kebutuhan pemahaman business process, kemampuan analisis kebutuhan pelanggan, penerjemahan masalah bisnis menjadi solusi digital, dengan target lulusan memahami alur problem $\to$ analysis $\to$ solution $\to$ implementation.
\item \textbf{Pengembangan Sistem Cerdas Terapan} --- cakupan kompetensi, teknologi/tools yang diperkenalkan, bentuk proyek, output kompetensi mahasiswa, serta alur kompetensi dari mata kuliah dasar hingga implementasi sistem cerdas (selaras dengan CPL07 pada Bab IV dan mata kuliah spesialisasi Kecerdasan Artifisial/Pembelajaran Mesin pada Kurikulum 2025, serta cakupan Laboratorium Intelligent Vision and Smart System).
\item \textbf{Penentuan Body of Knowledge (BoK) Program Studi} --- BoK direncanakan menjadi dasar penentuan kelompok keilmuan, struktur mata kuliah, kompetensi dosen, pengembangan laboratorium, bidang peminatan, dan kerja sama industri.
\item \textbf{Evaluasi dan Pengembangan Laboratorium} --- kesesuaian bidang laboratorium dengan BoK, hubungan laboratorium dengan mata kuliah, keterlibatan industri, penggunaan kasus industri dalam praktikum/proyek, serta kompetensi minimal mahasiswa sebelum mengikuti kegiatan laboratorium (mengacu pada 8 laboratorium KBK yang telah disusun pedomannya, lihat \texttt{docs/pedoman-laboratorium/}).
\item \textbf{Penggunaan Tools dalam Pembelajaran} --- jenis tools yang banyak digunakan industri, kompetensi dasar penggunaan tools, hubungan tools dengan konsep/teori, serta metode pembelajaran yang efektif untuk mengenalkan tools.
\item \textbf{Evaluasi CPL dan CPMK} --- definisi kompetensi tiap CPL, indikator ketercapaian, batas minimal (threshold) kompetensi, rubrik penilaian CPL, hubungan CPL dengan CPMK, serta kemungkinan pemantauan perkembangan kompetensi mahasiswa secara berkelanjutan (langsung berkaitan dengan CPL dan CPMK Kurikulum 2025 pada Bab IV).
\item \textbf{Integrasi CPL/CPMK dengan Laboratorium} --- pemetaan kemampuan mahasiswa berdasarkan CPMK, rekomendasi bidang laboratorium berdasarkan kompetensi, pemantauan ketercapaian kompetensi melalui sistem/dashboard, serta penguatan mahasiswa pada kompetensi yang belum memenuhi standar.
\item \textbf{Penguatan Soft Skill dan Karakter Mahasiswa} --- motivasi kerja, kemampuan bekerja dalam tim, komunikasi, integritas, disiplin, kemampuan beradaptasi, dan ketahanan menghadapi tekanan di dunia kerja.
\item \textbf{Penyelarasan Program Studi dengan Potensi Daerah} --- pemanfaatan teknologi informasi untuk mendukung sektor pariwisata, perhotelan, biro perjalanan, ekonomi kreatif, UMKM, serta digitalisasi layanan dan proses bisnis daerah.
\item \textbf{Persiapan Bahan untuk Pertemuan Advisory Board} --- disepakati bahan yang disiapkan meliputi profil program studi; visi, misi, dan positioning; struktur kurikulum yang sedang berjalan; daftar CPL dan CPMK; pemetaan mata kuliah dan kompetensi; struktur laboratorium; Body of Knowledge; rencana pengembangan Sistem Cerdas Terapan; pola kerja sama dengan industri; serta daftar pertanyaan dan isu strategis yang memerlukan masukan Advisory Board.
\end{enumerate}

Kesimpulan rapat: pertemuan dengan Advisory Board akan difokuskan untuk memperoleh masukan eksternal terkait positioning Program Studi, relevansi kurikulum, kebutuhan kompetensi industri, Body of Knowledge, pengembangan laboratorium, Sistem Cerdas Terapan, ketercapaian CPL/CPMK, integrasi kompetensi teknis dan bisnis, serta penguatan karakter lulusan. Rapat internal ini menjadi bukti berjalannya siklus kaji ulang Kurikulum 2025 secara berkelanjutan; hasil pertemuan dengan Advisory Board selanjutnya akan menjadi langkah konkret berikutnya untuk memperkuat Kurikulum 2025 Program Studi D4 Teknik Informatika.
...
Survei tracer study 2022--2024 di atas tidak mencakup penilaian aspek kompetensi (hard skill/soft skill) lulusan. Poin-poin berikut adalah temuan kualitatif dari tracer study kurikulum 2020 (alumni lulusan 2017/2018--2019/2020, 199 partisipan) dan dipertahankan sebagai catatan historis, bukan data final.
