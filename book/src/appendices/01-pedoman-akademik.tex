...
\begin{tblr}{width=\textwidth,colspec={Q[c,m,0.6cm]Q[l,m,2.2cm]X[l,m]Q[c,m,1.95cm]Q[c,m,1.4cm]Q[c,m,1.4cm]Q[c,m,0.8cm]},hlines,vlines,hspan=minimal,rowsep=1pt,row{1}={bg=headgray,font=\bfseries}}
...
\textit{Deskripsi mata kuliah berikut disusun langsung dari RPS Kurikulum 2025 (Lampiran II), sumber yang paling akurat dan terkini untuk setiap mata kuliah.}
